...
| `Zaik.Home.Autonomy.ManualOverrideStore` | Durable expiring area/home override leases with ownership, reasons, capability scope, and cancellation audit. | Feed explicit manual actions into leases automatically. |
