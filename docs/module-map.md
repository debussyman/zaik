...
| `Zaik.Home.StagedPlanAlerts` | Explicit operator delivery of typed watchdog issues with durable fingerprint cooldown and hashed destination audit. | Consider opt-in supervised periodic delivery only after telemetry-failure alerting is durable. |
