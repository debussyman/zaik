...
| `Zaik.Home.WorldContract` | Versioned runtime-discovered canonical entity/capability, freshness, snapshot, and calibration schemas with stable state-free fingerprints. | Extend with desired-state, confidence, and richer provenance contracts under explicit schema versions. |
