...
| `Zaik.Home.StagedPlanCoordinator` | Supervised ledger-protected stage execution, canonical reobservation, separate condition/verification waits, convergence-gated advancement, cooperative cancellation, and durable mirror-only resume. | Add policy-gated staged retries before considering any production binding. |
