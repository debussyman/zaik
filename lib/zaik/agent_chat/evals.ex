defmodule Zaik.AgentChat.Evals do
  ...
  def cases do
    [
      %{
        name: "ops_messages_today",
        prompt: "what have we asked you today?",
        expected_db: :ops,
        expected_query_terms: ["zaik_messages"],
  ...
  defp run_case(case_def, model, timeout_ms) do
    ...
    response =
      Zaik.AgentChat.respond(case_def.prompt, %{},
  ...
  defp query_terms?(calls, terms) do
    ...
    Enum.all?(terms, &String.contains?(query_text, String.downcase(&1)))
  end
